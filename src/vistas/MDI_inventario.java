 ...
 * @author lemag
 */
public class MDI_inventario extends javax.swing.JFrame {
    FRMRegistrarse fRegistrarse;
    FRMLogin fLogin;
    /**
     * Creates new form MDI_inventario
     */
    ...
    private void initComponents() {
        ...
        itemLogin.addActionListener(this::itemLoginActionPerformed);
        fileMenu.add(itemLogin);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MDI_inventario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MDI_inventario().setVisible(true);
            }
        });
    }
