...
public class FRMLogin extends javax.swing.JInternalFrame {
    ...
    public FRMLogin() {
        ...
        ThemeUtil.styleCard(jPanel3);
        jPanel3.setBorder(BorderFactory.createCompoundBorder(
            new LineBorder(ThemeUtil.PRIMARY, 2, true),
            BorderFactory.createEmptyBorder(20, 20, 20, 20)
        ));

        ThemeUtil.styleLabel(jLabel1, ThemeUtil.PRIMARY, ThemeUtil.FONT_TITLE_BIG);
        ThemeUtil.styleLabel(jLabel3, ThemeUtil.PRIMARY, ThemeUtil.FONT_SECTION);
        ...
        ThemeUtil.stylePrimaryButton(bt_entrar);
        ThemeUtil.styleSecondaryButton(bt_registro);
